...
namespace WCF_PeruHotel
{
    ...
    {
        [OperationContract]
        List<dataHabitacion> ListarTipoHabitacion();

        [OperationContract]

        List<dataHabitacion> ListarHabitacionDisponiblePorTipo(String strIdTipo);

        [OperationContract]

        dataHabitacion GetDetalleTipoHabitacion(String strIdTipo);
    }
